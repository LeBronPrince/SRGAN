...
def evaluate():
    ...
    for imid in range(58,59):#len(valid_lr_imgs)
        ...
        print("[*] save images")
        tl.vis.save_image(out[0], save_dir+'/valid_gen%d.png' % imid)
        tl.vis.save_image(valid_lr_img, save_dir+'/valid_lr%d.png' % imid)
        tl.vis.save_image(valid_hr_img, save_dir+'/valid_hr%d.png' % imid)
