...
ssim_sum = 0
for i in range(14):
	image = scipy.misc.imread('/home/wangyang/桌面/SRGAN/samples/evaluate/set14/%d/valid_gen%d.png'%(i,i))
	image_true = scipy.misc.imread('/home/wangyang/桌面/SRGAN/samples/evaluate/set14/%d/valid_hr%d.png'%(i,i))
